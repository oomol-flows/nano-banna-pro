...
### 3. Try It Out (Example Workflows)

Sample workflows show you exactly how everything works together. Use them as they are, or as inspiration for your own creations.
...
Choose options that match your needs:

**Image Shape:**
- Square (1:1) - Great for social media posts
- Widescreen (16:9) - Perfect for presentations or videos
- Portrait (9:16) - Ideal for phone wallpapers or stories
- And many more aspect ratios to choose from

**Image Quality:**
- 1K - Quick previews and testing ideas
- 2K - Good quality for most uses
...
- What's the setting? (location, time of day, weather)
- What's the style? (realistic, artistic, dreamy, dramatic)
...
Begin with 1K quality to test your idea quickly. Once you're happy with the result, recreate it in higher quality.

**Match Shape to Purpose:**
- Posting on Instagram? → Square works great
- Making a YouTube thumbnail? → Use widescreen
- Creating phone wallpaper? → Choose portrait

**Consider File Size:**
- PNG for when quality matters most
- JPEG for when you need smaller files
...
Higher quality images take longer to create, but the results are worth waiting for. Plan ahead if you need images quickly.

**Learn From Each Try:**
Notice what descriptions work best and refine your approach over time.
...
The tool will automatically wait for your image to finish - you don't need to keep checking.

### "What if my image doesn't look right?"
...
**Image not appearing?**
- Check that your description is clear
- Make sure you're connected to the internet
- Try a simpler image first to test

**Taking too long?**
- High quality naturally takes more time
- You can adjust the timeout setting if needed
- Starting with lower quality helps you preview faster
...
**Settings:** Widescreen (16:9), 1K quality, PNG format
